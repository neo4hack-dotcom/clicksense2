...
interface AppState {
  ...
  activeTab: 'chat' | 'builder' | 'dashboard' | 'settings' | 'knowledge' | 'rag' | 'data-quality' | 'agents' | 'agent-manager';
  setActiveTab: (tab: 'chat' | 'builder' | 'dashboard' | 'settings' | 'knowledge' | 'rag' | 'data-quality' | 'agents' | 'agent-manager') => void;
